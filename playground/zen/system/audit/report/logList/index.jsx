...
export default function ({ data = [], meta = {}, t }) {
  ...
  const columns = [
    ...
    { id: "level", header: utils.cellHeader(t("/@word/level")), width: "16ch" },
    {
      id: "dateTime",
    ...
    { id: "day", header: utils.cellHeader(t("/@word/day")), width: "8ch" },
    { id: "month", header: utils.cellHeader(t("/@word/month")), width: "8ch" },
    { id: "year", header: utils.cellHeader(t("/@word/year")), width: "8ch" },
    { id: "operation", header: utils.cellHeader(t("/system/audit/log.operation")), width: "20ch" },
    { id: "source", header: utils.cellHeader(t("/@word/source")), width: "20ch" },
    {
      id: "contentType",
      header: utils.cellHeader(t("/system/audit/log.contentType")),
      width: "16ch",
    },
    { id: "content", header: utils.cellHeader(t("/system/audit/log.content")), width: "32ch" },
    {
      id: "expiration",
    ...
    { id: "tags", header: utils.cellHeader(t("/@word/tags")), width: "16ch" },
    {
      id: "properties",
    ...
    { id: "properties_ms", header: utils.cellHeader(t("/@word/time/ms")), width: "16ch" },
    {
      id: "session_id",
