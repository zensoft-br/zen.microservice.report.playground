...
export default function ({ data = [], meta = {}, t }) {
  ...
  const columns = [
    ...
    },
    {
      ...
      width: "16ch",
      cell: ({ value }) =>
        value ? <Badge>{t(`/trade/contractStatus/enum/${value}`)}</Badge> : null,
    },
    {
    ...
    // CONTRACT_ITEM
    {
      ...
      className: "number",
      cell: ({ row, value }) =>
        utils.formatCurrency(value, { currency: row.contract_currency_code }),
    },
    {
      ...
      footerValue: ({ data }) =>
        utils.sumBy(
          data,
          (item) => item.unit_code,
          (item) => item.sum_contractItem_quantity,
        ),
      footer: ({ value }) =>
        utils.renderAggr(value, (val, unit_code) => utils.formatQuantity(val, { unit_code })),
    },
    {
    ...
    },
    {
      ...
      footerValue: ({ data }) =>
        utils.sumBy(
          data,
          (item) => item.unit_code,
          (item) => item.sum_contractItem_shippedQuantity,
        ),
      footer: ({ value }) =>
        utils.renderAggr(value, (val, unit_code) => utils.formatQuantity(val, { unit_code })),
    },
    {
      ...
      footerValue: ({ data }) =>
        utils.sumBy(
          data,
          (item) => item.unit_code,
          (item) => item.sum_contractItem_clearedQuantity,
        ),
      footer: ({ value }) =>
        utils.renderAggr(value, (val, unit_code) => utils.formatQuantity(val, { unit_code })),
    },
    {
      ...
      footerValue: ({ data }) =>
        utils.sumBy(
          data,
          (item) => item.contract_currency_code,
          (item) => item.sum_contractItem_totalValue,
        ),
      footer: ({ value }) =>
        utils.renderAggr(value, (val, currency) => utils.formatCurrency(val, { currency })),
    },
    {
    ...
    },
    {
      ...
      width: "16ch",
      cell: ({ value }) =>
        value ? <Badge>{t(`/trade/shipmentStatus/enum/${value}`)}</Badge> : null,
    },
    {
    ...
    },
    {
      ...
      footerValue: ({ data }) =>
        utils.sumBy(
          data,
          (item) => item.unit_code,
          (item) => item.sum_shipmentItem_quantity,
        ),
      footer: ({ value }) =>
        utils.renderAggr(value, (val, unit_code) => utils.formatQuantity(val, { unit_code })),
    },
    ...
    },
    {
      ...
      footerValue: ({ data }) =>
        utils.sumBy(
          data,
          (item) => item.contract_currency_code,
          (item) => Number(item.sum_shipmentItem_totalValue) || 0,
        ),
      footer: ({ value }) =>
        utils.renderAggr(value, (val, currency) => utils.formatCurrency(val, { currency })),
    },
    ...
    },
    {
      ...
      width: "16ch",
      cell: ({ value }) =>
        value ? <Badge>{t(`/trade/clearanceStatus/enum/${value}`)}</Badge> : null,
    },
    {
    ...
    // CLEARANCE_ITEM
    {
      ...
      footerValue: ({ data }) =>
        utils.sumBy(
          data,
          (item) => item.unit_code,
          (item) => item.sum_clearanceItem_quantity,
        ),
      footer: ({ value }) =>
        utils.renderAggr(value, (val, unit_code) => utils.formatQuantity(val, { unit_code })),
    },
    ...
    },
    {
      ...
      footerValue: ({ data }) =>
        utils.sumBy(
          data,
          (item) => item.contract_currency_code,
          (item) => Number(item.sum_clearanceItem_totalValue) || 0,
        ),
      footer: ({ value }) =>
        utils.renderAggr(value, (val, currency) => utils.formatCurrency(val, { currency })),
    },
