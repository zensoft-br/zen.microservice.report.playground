...
export default function ({ data = [], meta = {}, t }) {
  ...
  const columns = [
    ...
    { id: "contract_tags",
      header: utils.cellHeader(t("/trade/contract"), t("/@word/tags")),
      width: "16ch",
    },
    { id: "company_id",
    ...
    { id: "contractItem_unitValueUnits",
      header: utils.cellHeader(t("/trade/contractItem"), t("/@word/unitValueUnits")),
      width: "16ch",
      className: "number",
      cell: ({ value }) => utils.formatCurrency(value),
    },
    ...
    { id: "count_contract",
      header: utils.cellHeader(t("/trade/contract"), t("/@word/count")),
      width: "16ch",
      className: "number",
      headerClassName: "number",
      cell: ({ value }) => utils.formatNumber(value),
      footerValue: ({ data }) => data.reduce((red, item) => red + (Number(item.count_contract) || 0), 0),
      footer: ({ value }) => utils.formatNumber(value),
    },
    { id: "count_contractItem",
      header: utils.cellHeader(t("/trade/contractItem"), t("/@word/count")),
      width: "16ch",
      className: "number",
      headerClassName: "number",
      cell: ({ value }) => utils.formatNumber(value),
      footerValue: ({ data }) => data.reduce((red, item) => red + (Number(item.count_contractItem) || 0), 0),
      footer: ({ value }) => utils.formatNumber(value),
    },
  ];
