                ...
                <div className="frame">
                  <div className="band h" style={{ gridTemplateColumns: "50% 25% 25%" }}>
                    ...
                    <div className="slot">
                      ...
                      <div className="date">{utils.formatDate(item.date)}</div>
                    </div>
                  </div>
                  <div className="band h" style={{ gridTemplateColumns: "50% 17% 17% 16%" }}>
                    ...
                    <div className="slot">
                      ...
                      <div className="date">{utils.formatDate(item.shippingDateTime)}</div>
                    </div>
                  </div>
                  <div className="band h" style={{ gridTemplateColumns: "45% 5% 17% 17% 16%" }}>
                    ...
                    <div className="slot">
                      ...
                      <div>{utils.formatTime(item.shippingDateTime)}</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="frame" >
                  ...
                  <div className="band h" style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)" }}>
                    ...
                    <div className="slot">
                      ...
                      <div className="number">{utils.formatCurrency(item.totalValue ?? 0)}</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="frame">
                  ...
                  <div className="band h" style={{ gridTemplateColumns: "1fr 1fr 1fr 1fr 1fr 1fr" }}>
                    ...
                    <div className="slot">
                      ...
                      <div className="number">{utils.formatNumber(item.grossWeightKg)}</div>
                    </div>
                    <div className="slot">
                      <label>{t("/@word/netWeightKg")}</label>
                      <div className="number">{utils.formatNumber(item.netWeightKg)}</div>
                    </div>
                  </div>
                </div>
...
function splitInBlocks(str, size = 4) {
