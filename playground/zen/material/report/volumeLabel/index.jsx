        ...
        <div className={`report-container ${settings?.pageSize ?? "a4"} ${settings?.orientation}`}>
          <main className="flex v flex-1">
            <div className="content flex v flex-1">
              <div
                className="flex h"
                style={{ flex: "2 0 0", display: "grid", gridTemplateColumns: "2fr 1fr 2fr 2fr" }}
              >
                <dl>
                ...
                <dl className="flex v" style={{ alignItems: "center", justifyContent: "center" }}>
                  <dt>{t("/sale/sale")}</dt>
                  <dd style={{ fontSize: "1.8em" }}>
                    <strong>{obj.sale_id ? obj.sale_id : "\u00A0"}</strong>
                  </dd>
                </dl>
                <dl className="flex v" style={{ alignItems: "center", justifyContent: "center" }}>
                  ...
                  <dd style={{ fontSize: "1.8em" }}>
                    <strong>
                      {obj.invoice_number ? utils.formatNumber(obj.invoice_number) : "\u00A0"}
                    </strong>
                  </dd>
                </dl>
              ...
              <div
                style={{ flex: "1 0 0", display: "grid", gridTemplateColumns: "repeat(3, 1fr)" }}
              >
                <dl style={{ flex: "1 0 0" }}>
              ...
              <div style={{ flex: "1 0 0", display: "grid", gridTemplateColumns: "3fr 1fr" }}>
                ...
                <dl style={{ flex: "1 0 0" }}>
                  ...
                  <dd className="number">
                    {obj.grossWeightKg ? utils.formatNumber(obj.grossWeightKg) : "\u00A0"}
                  </dd>
                </dl>
              </div>
            </div>
          </main>
          <div className="zen-ad" style={{ fontSize: "0.5em", textAlign: "right" }}>
            zenerp.com.br
          </div>
        </div>
      ))}
