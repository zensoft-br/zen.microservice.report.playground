          ...
          <main className="flex flex-1">
            <div className="content flex v flex-1">
              <div style={{ position: "absolute", top: "4.83cm", left: "2.82cm" }}>
                {obj.code}, {obj.vol_x} de {obj.vol_y}
              </div>
              <img
                style={{ position: "absolute", top: "4cm", left: "14cm", width: "1.5cm" }}
                src={`https://barcode.zensoft.com.br?bcid=qrcode&text=${obj.code}`}
              ></img>
              <div style={{ position: "absolute", top: "5.54cm", left: "3.95cm" }}>
                {obj.person_name}
              </div>
              ...
              <div style={{ position: "absolute", top: "7.66cm", left: "3.46cm" }}>
                {obj.person_address_zipcode}
              </div>
              <div
                style={{ position: "absolute", top: "7.66cm", left: "9.45cm" }}
              >{`${obj.person_address_city}, ${obj.person_address_state_code}`}</div>
              <div style={{ position: "absolute", top: "8.36cm", left: "4.94cm", maxWidth: "8cm" }}>
                {obj.personShipping_name}
              </div>
              <div style={{ position: "absolute", top: "8.36cm", left: "12.95cm" }}>
                {utils.formatNumber(obj.invoice_number)}
              </div>
            </div>
          </main>
